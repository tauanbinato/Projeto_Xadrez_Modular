##################################################
###
### Diretivas de MAKE para o construto: TesteAleatorio
### Gerado a partir de: TesteAleatorio.comp
###
...
$(Fobj)\testalt.obj :  {$(Pc)}\testalt.c \
    {$(Ph)}generico.h           {$(Ph)}geraalt.h            {$(Ph)}lerparm.h            \
    {$(Ph)}tst_espc.h          
   cl $(O) $(OPT) /Fo$(Fobj)\ $(Fc)\$(@B).c >> $(Ferr)\$(NOME).err
...
##################################################
###
### Fim de diretivas MAKE para o construto: TesteAleatorio
###
##################################################
